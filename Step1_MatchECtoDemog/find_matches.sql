...
drop table if exists x_fn_distint, x_fn_cnt, x_fn_unique\p\g
...
drop table if exists x_ln_distint, x_ln_cnt, x_ln_unique\p\g
...
drop table x_ph_distint, x_ph_cnt, x_ph_unique\p\g
...
drop table x_zip_distint, x_zip_cnt, x_zip_unique\p\g
...
drop table x_fn_ln_distint, x_fn_ln_cnt, x_fn_ln_unique\p\g
...
drop table x_fn_ph_distint, x_fn_ph_cnt, x_fn_ph_unique\p\g
...
drop table if exists x_fn_zip_distint, x_fn_zip_cnt, x_fn_zip_unique\p\g
...
drop table x_ln_ph_distint, x_ln_ph_cnt, x_ln_ph_unique\p\g
...
drop table x_ln_zip_distint, x_ln_zip_cnt, x_ln_zip_unique\p\g
...
drop table if exists x_ph_zip_distint, x_ph_zip_cnt, x_ph_zip_unique\p\g
...
from x_ec_processed a
join x_fn_ln_ph_unique b on a.EC_FirstName = b.FirstName and a.EC_LastName = b.LastName and a.EC_PhoneNumber = b.PhoneNumber\p\g

drop table x_fn_ln_ph_distint, x_fn_ln_ph_cnt, x_fn_ln_ph_unique\p\g
...
drop table x_fn_ln_zip_distint, x_fn_ln_zip_cnt, x_fn_ln_zip_unique\p\g
...
drop table x_fn_ph_zip_distint, x_fn_ph_zip_cnt, x_fn_ph_zip_unique\p\g
...
drop table x_ln_ph_zip_distint, x_ln_ph_zip_cnt, x_ln_ph_zip_unique\p\g
...
drop table if exists x_fn_ln_ph_zip_distint, x_fn_ln_ph_zip_cnt, x_fn_ln_ph_zip_unique\p\g
