...
/*!40101 SET @OLD_CHARACTER_SET_CLIENT=@@CHARACTER_SET_CLIENT */\p\g
/*!40101 SET @OLD_CHARACTER_SET_RESULTS=@@CHARACTER_SET_RESULTS */\p\g
/*!40101 SET @OLD_COLLATION_CONNECTION=@@COLLATION_CONNECTION */\p\g
/*!40101 SET NAMES utf8 */\p\g
/*!40014 SET @OLD_FOREIGN_KEY_CHECKS=@@FOREIGN_KEY_CHECKS, FOREIGN_KEY_CHECKS=0 */\p\g
/*!40101 SET @OLD_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO' */\p\g
/*!40111 SET @OLD_SQL_NOTES=@@SQL_NOTES, SQL_NOTES=0 */\p\g
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1\p\g
...
CREATE TABLE `family_IDs` (
  ...
  KEY `family_id` (`family_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='#DONT USE THIS TABLE FOR HERITABILITY ANALYSIS!\n\nNot all patients here are in pedigree  - this file includes families where 1+ patient has more than one relationship'\p\g
...
CREATE TABLE `family_ids_forpedigree` (
  ...
  `individual_id` varchar(20) DEFAULT NULL,
  KEY `mrn` (`individual_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='CREATE INDEX pat_mrn'\p\g
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='#Uncle seems to be under AU'\p\g
...
/*!40111 SET SQL_NOTES=@OLD_SQL_NOTES */\p\g
/*!40101 SET SQL_MODE=@OLD_SQL_MODE */\p\g
/*!40014 SET FOREIGN_KEY_CHECKS=@OLD_FOREIGN_KEY_CHECKS */\p\g
/*!40101 SET CHARACTER_SET_CLIENT=@OLD_CHARACTER_SET_CLIENT */\p\g
/*!40101 SET CHARACTER_SET_RESULTS=@OLD_CHARACTER_SET_RESULTS */\p\g
/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */\p\g
